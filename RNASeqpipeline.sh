...
cd /Users/azami/Documents/Bioinformatics/RNASeq_pipeline/
...
featureCounts -S 2 -a ./HISAT2/Homo_sapiens.GRCh38.106.gtf -o quants/demo_featurecounts.txt HISAT2/demo_trimmed.bam
